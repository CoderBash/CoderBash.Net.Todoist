...
{
    /// <summary>
    /// Model for updating an existing <see cref="TodoistTask">Todoist Task</see>.
    /// </summary>
	public class UpdateTodoistTaskModel
	{
        /// <summary>
        /// [Optional] Task content. This value may contain markdown-formatted text and hyperlinks.
        /// </summary>
